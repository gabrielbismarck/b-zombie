...
#include <memory> // Incluído para suporte a shared_ptr e weak_ptr
...
class Resources {
    public:
        // Métodos agora retornam shared_ptr em vez de ponteiros crus
    ...
    private:
        // Tabelas agora armazenam shared_ptr para controle de referência
